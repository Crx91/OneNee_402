...
- Virtually no noise or degradation on the laser RF signal level unlike the old onechip mod.
- No atmega328p+16mhz cristal or other arduino uno like "big" board, simply a 8-pin ATtiny 402 chip to solder that can be easly fitted in your console!
